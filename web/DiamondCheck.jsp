                ...
                <div class="relative overflow-hidden">
                    <main>
                        ...
                        <div class="relative isolate pt-8 sm:pt-14">
                            ...
                            <div class="mx-auto max-w-7xl px-6 pb-24 sm:pb-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:pb-32">
                                <div class="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
                                    ...
                                    <div class="mt-10 sm:mt-12">
                                        <div id="sa-check_inputs" class="sm:max-w-xl sm:mx-auto lg:mx-0">
                                            ...
                                            <form action="MainController" method="post">
                                                <div class="sm:flex">                            
                                                    <div class="min-w-0 flex-1">
                                                        <label id="sa-cert_input_label" class="text-xs min-h-[16px]">
                                                        </label>
                                                        <input id="sa-cert_id" type="text" class="block w-full px-4 py-3 rounded-md text-base text-gray-900 font-normal placeholder-gray-500 border-gray-200 border-2 focus:border-2 focus:border-blue-400 outline-none focus:ring-0 focus:shadow-md shadow-stripe" placeholder="Enter Certificate ID" name="txtCertificateID" onkeydown="if (event.key === '.') {
                                                    ...
                                                    <!--                                                    <div class="mt-3 sm:mt-0 sm:ml-3">
                                                                                                            <button id="sa-run_check" type="submit" name="btAction" value="CheckDiamond" class="block w-full h-full py-3 px-4 rounded-md shadow bg-indigo-500 text-white font-medium hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-300 focus:ring-offset-gray-900">Run free check</button>
                                                                                                        </div>    -->
                                                    <button type="submit" name="btAction" value="CheckDiamond">
                                                        Run Free Check
                                                    </button>
                                                    <%
