                                    ...
                                    <div class="row  mt-5">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="card mb-5 mb-lg-0">
                                                ...
                                                <div class="card-body">
                                                    <h5 class="card-title text-muted text-uppercase text-center"><%=service.getServiceName()%>
                                                        <input type="hidden" name="txtServiceName" value="<%=service.getServiceName()%>" />
                                                    </h5>
                                                    <h6 class="card-price text-center mt-3">$<%=service.getServicePrice()%><span class="period"></span>
                                                        <input type="hidden" name="floatPrice" value="<%=service.getServicePrice()%>" />
                                                    </h6>
                                                    <hr>
                                                    <ul class="fa-ul">
                                                        <%
                                                        ...
                                                        <li><span class="fa-li"><i class="fas fa-check"></i></span>
                                                            <input type="hidden" name="txtServiceCover" value="<%=serviceTypeCoverage.getIncludedService()%>" />
                                                    ...
                                                    <a href="EditServiceServlet" class="btn btn-block btn-primary text-uppercase">Edit</a>
