                ...
                <div class="content container-fluid">
                    <div class="page-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <div class="mt-5">
                                    <h4 class="card-title float-left mt-2">Customers</h4> <a href="customer-add.jsp" class="btn btn-primary float-right veiwbutton">Add Customers</a> </div>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="card-body booking_card">
                                    <div class="table-responsive">
                                        <table class="datatable table table-stripped table table-hover table-center mb-0">
                                            <%
                                                List<UsersDTO> customerList = (List<UsersDTO>) request.getAttribute("LISTCUSTOMER");
                                            %>   
                                            <thead>
                                                <tr>
                                                    <th>Customer ID</th>
                                            ...
                                            <tbody>
                                                <%
                                                    for (UsersDTO customer : customerList) {
                                                %>   
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <div class="dropdown dropdown-action"> <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v ellipse_color"></i></a>
                                                            <div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item" href="customer-edit.jsp"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a> <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_asset"><i class="fas fa-trash-alt m-r-5"></i> Delete</a> </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <% }%>
                                            ...
                                            <!--										<tbody>
                                                                                                ...
                                                                                                <a href="profile.jsp">Tommy Bernal <span>#0001</span></a>
                                                                                                                                            ...
                                                                                                                                            <td class="text-right">
                                                                                                                                                    <div class="dropdown dropdown-action"> <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v ellipse_color"></i></a>
                                                                                                                                                            <div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item" href="edit-customer.jsp"><i class="fas fa-pencil-alt m-r-5"></i> Edit</a> <a class="dropdown-item" href="#" data-toggle="modal" data-target="#delete_asset"><i class="fas fa-trash-alt m-r-5"></i> Delete</a> </div>
                                                                                                                                                    </div>
                                                                                                                                            </td>
                                                                                                                                    </tr>
                                                                                                                                    <tr>
                                                                                                ...
                                                                                                <a href="profile.jsp">Richard Brobst <span>#0002</span></a>
                                                                                                </h2>
                                                                                            </td>
                                                                                                                                            <td>Single</td>
                                                                                                                                            <td>8</td>
                                                                                                    ...
                                                                                                    <a href="profile.jsp">Ellen Thill <span>#0003</span></a>
                                                                                                </h2>
                                                                                            </td>
                                                                                                                                            <td>Double</td>
                                                                                                                                            <td>10</td>
                                                                                                ...
                                                                                                <a href="profile.jsp">Corina Kelsey <span>#0004</span></a>
                                                                                                </h2>
                                                                                            </td>
                                                                                                                                            <td>Single</td>
                                                                                                                                            <td>15</td>
                                                                                                ...
                                                                                                <a href="profile.jsp">Carolyn Lane <span>#0005</span></a>
                                                                                                </h2>
                                                                                            </td>
                                                                                                                                            <td>Double</td>
                                                                                                                                            <td>12</td>
                                                                                                ...
                                                                                                <a href="profile.jsp">David Alvarez <span>#0006</span></a>
                                                                                                </h2> 
                                                                                            </td>
                                                                                                                                            <td>Single</td>
                                                                                                                                            <td>7</td>
