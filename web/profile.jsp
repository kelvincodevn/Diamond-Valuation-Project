...
//                                            request.setAttribute("UserRole", role);
                        ...
                        <div class="dropdown-menu">
                            <div class="user-header">
                                ...
                                <div class="user-text">
                                    ...
                                    <p class="text-muted mb-0"><%=role.getRoleName()%></p>
                                </div>
            ...
            <div class="page-wrapper">
                            ...
                            <div class="profile-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col ml-md-n2 profile-user-info">
                                        <h4 class="user-name mb-3"><%=user.getFirstName()%> <%=user.getLastName()%></h4>
                                        <h6 class="text-muted mt-1"><%=role.getRoleName()%></h6>                                     
                                        <div class="about-text"><%=role.getRoleDescription()%></div>
                                    </div>
                                    <div 
                ...
                <%
                    ...
                    if (errors != null) {
                        oldpasswordError = errors.getOldPasswordError();
                        passwordLenError = errors.getPasswordLenError();
                        confirmNotMatch = errors.getConfirmNotMatch();
                        newPasswordError = errors.getNewPasswordError();
                        confirmPasswordError = errors.getConfirmPasswordError();
                    }
                %>
                                ...
                                <div class="col-md-10 col-lg-6">
                                    <form action="MainController" method="Post">
                                        <div class="form-group">
                                            ...
                                            <input type="password" name="txtOldPassword" value="${sessionScope.oldPassword}" class="form-control"> </div>
                                        <font color="red">${requestScope.ERRORS.getOldPasswordError()}</font>
                                        <font color="red">${requestScope.ERROROLDPASSWORD}</font>
                                        <div class="form-group">
                                            <label>New Password</label>
                                            <input type="password" name="txtNewPassword" value="${sessionScope.newPassword}" class="form-control"> </div>
                                        <font color="red">${requestScope.ERRORS.newPasswordError}</font>
                                        <font color="red">${requestScope.ERRORS.passwordLenError}</font>
                                        <div class="form-group">
                                            <label>Confirm Password</label>
                                            <input type="password" name="txtConfirmPassword" value="${sessionScope.confirmPassword}" class="form-control"> </div>
                                        <font color="red">${requestScope.ERRORS.confirmPasswordError}</font>
                                         <font color="red">${requestScope.ERRORS.confirmNotMatch}</font><br/>
                                        <button class="btn btn-primary" type="submit" name="btAction" value="Change Password">Save Changes</button>
                                    </form>
                                </div>
                            </div>
                        </div>
