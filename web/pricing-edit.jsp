...
%>   
                                                        ...
                                                        <li><span class="fa-li"><i class="fas fa-check"></i></span>
                                                            ...
                                                            <input type="hidden" name="txtCoverID" value="<%=serviceTypeCoverage.getServiceTypeCoverageID()%>" />
                                                            <input type="hidden" name="txtServiceCover<%=count%>" value="<%=serviceTypeCoverage.getIncludedService()%>" />
                                ...
                                <div class="row formtype">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="txtServiceName">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Service Price</label>
                                            <input class="form-control" type="text" name="floatPrice">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
...
<!--                                            </div>-->
                                ...
                                <div class="row formtype">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <label>Service Price</label>
                                            <input class="form-control" type="text" name="floatPrice" value="">
                                        </div>
