        ...
        <script>
            ...
            function addService() {
                ...
                serviceDiv.innerHTML = `
                       <label for="includedService${serviceCount}">Included Service ${serviceCount}</label>
                       <input type="text" id="includedService${serviceCount}" name="includedService" required>
                       <label for="detailedDescription${serviceCount}">Detailed Description ${serviceCount}</label>
                       <textarea id="detailedDescription${serviceCount}" name="detailedDescription" required></textarea>
                       <button type="button" class="remove-service-btn" onclick="removeService(this)">Remove</button>
                   `;
                document.getElementById('includedServices').appendChild(serviceDiv);
            }
                                    ...
                                    <div class="row formtype">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="txtServiceName" type="text" value=""> </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Pricing Amount</label>
                                                <input type="text" name="txtServicePrice" class="form-control" id="usr"> </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Execution Time</label>
                                                <input type="text" name="txtExecutionTime" class="form-control" id="usr1"> </div>
                                        </div>							
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>Pricing Description</label>
                                                <textarea class="form-control" rows="5" id="comment" name="txtServiceDescription"></textarea>
                                            </div>
                                        </div>
                                        <div id="includedServices">
                                            <h3>Included Services</h3>
                                            <div class="form-group">
                                                <label for="includedService1">Included Service</label>
                                                <input type="text" id="includedService1" name="includedService" required>
                                                <label for="detailedDescription1">Detailed Description</label>
                                                <textarea id="detailedDescription1" name="detailedDescription" required></textarea>
                                            </div>
                                        </div>                                   
                                    </div>
                                    <button type="button" class="add-service-btn" onclick="addService()">Add more</button>
                                </form>
                            </div>
                        </div>
                        <button type="submit" name="btAction" value="Add Service" class="btn btn-primary buttonedit mt-5">Publish Pricing</button>
                    </form>
                </div>
            </div>
        </div>
