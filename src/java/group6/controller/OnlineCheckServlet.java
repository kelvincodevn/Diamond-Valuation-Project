...
public class OnlineCheckServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = "Checking.jsp";
        String price = null;
        PrintWriter out = response.getWriter();
        try {
            String ID = request.getParameter("ID");
            DiamondInfoDAO dao = new DiamondInfoDAO();
            price = dao.PriceCheckByID(ID);
            if (price == null) {
                String errorMSG = "ID is not valid";
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(OnlineCheckServlet.class.getName()).log(Level.SEVERE, null, ex);
