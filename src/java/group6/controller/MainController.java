...
public class MainController extends HttpServlet {
    ...
    private String SUBMIT_REQUEST_FORM_SERVLET = "SubmitRequestFormServlet";
    private final String CREATE_NEW_REQUEST = "createRequestServlet";
    private final String VIEW_ALL_BY_CUSTOMER = "ViewRequestServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (btAction == null) {
                ...
                url = ONLINE_CHECKING;
            }else if(btAction.equals("CheckLogin")) {
                url = CHECK_FOR_LOGIN_TO_REQUEST;
            }else if(btAction.equals("ViewRequestForm")) {
                url = VIEW_REQUEST_FORM_SERVLET;
            }else if(btAction.equals("RequestForm")) {
                url = SUBMIT_REQUEST_FORM_SERVLET;
            } else if(btAction.equals("SendNewRequest")){
